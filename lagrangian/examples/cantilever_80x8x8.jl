# High-resolution elastoplastic cantilever: 80×8×8 = 5120 Hex8 elements.
# Same setup as examples/cantilever.jl Part 2, but on a refined mesh.
...
println("\n=== elastoplastic cantilever 80×8×8 (Pp = ", Pp, ") ===")
...
println("\nwrote: ", write_vtu(joinpath(@__DIR__, "cantilever_plastic_80x8x8"), pmodel))
